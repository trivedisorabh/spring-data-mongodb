...
import org.springframework.data.mongodb.monitor.Task.State;
import org.springframework.data.mongodb.monitor.TaskFactory.CursorReadingTask;
...
public class CursorReadingTaskUnitTests {
	...
	static class ValueCapturingTaskStub extends CursorReadingTask {
		...
		@Override
		protected Message doCreateMessage(Object source, RequestOptions options) {
			values.add(source);
			return super.doCreateMessage(source, options);
		}
